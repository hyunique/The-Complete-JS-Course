...
class App {
    ...
    _loadMap(position) {
        ...
        //this method is not built in JS, it's from leaflet
    ...
    _newWorkout(e) {
        ...
        //to prevent default nature(reload) of submit
        e.preventDefault()

        // Get data from form
        const type = inputType.value;
        const distance = +inputDistance.value; //+ is used to convert string to number
...
`;
    ...
    reset() {
        ...
        location.reload(); //to reset the window page
    }
}
