...
const checkDogs = function (dogsJulia, dogsKate) {
    ...
    const total = onlyDogs.concat(dogsKate);
...
const calcAverageHumanAge = function (dogAges) {
    ...
    const isAdult = humanAge.filter(mov => mov >= 18);
    const average = isAdult.reduce((acc, cur) =>acc + cur,0) / isAdult.length;
    return average 
}
...
// dogs.map(obj=> obj.recommendedFood = Math.floor(obj.weight ** 0.75 * 28))
console.log(dogs)
...
*/
const goodDog = dogs.some(obj => obj.curFood === obj.recommendedFood)
console.log(goodDog)
...
*/
console.log(dogs.some(obj => obj.curFood > obj.recommendedFood * 0.9 && obj.curFood < obj.recommendedFood * 1.1));
...
*/
const okFood = dogs.filter(obj => obj.curFood > obj.recommendedFood * 0.9 && obj.curFood < obj.recommendedFood * 1.1)
console.log(okFood)
